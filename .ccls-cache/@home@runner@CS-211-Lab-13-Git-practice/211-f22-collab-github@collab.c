...
void aenca2() {
  printf("Avridean Encarnacion\n");
  printf("A command not addressed in lab prep, 'git init' allows you to initialize a repository in a directory. This adds the .git folder.\n");
}
